...
4. **Archiving:** The GitHub Action pipeline wakes up a bot user (`github-actions[bot]`), auto-commits the newly spawned file directly to the repository branch, and pushes cleanly with a verified signature.
